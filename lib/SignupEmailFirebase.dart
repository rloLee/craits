...
class SignupEmailFirebase extends StatefulWidget {
  ...
  @override
  _SignupEmailFirebaseState createState() => _SignupEmailFirebaseState();
}

class _SignupEmailFirebaseState extends State<SignupEmailFirebase> {
                ...
                child: DefaultButton(
                  ...
                  onPressed: () async {
                    ...
                    if(strEmail.length == 0 || strNickname.length == 0 || strPassword.length == 0 || strPasswordCheck.length == 0) {
                      ...
                      firebaseCreateUser(strEmail, strPassword);
                    }
                  },
                ),
              ),
  ...
  void firebaseCreateUser(String email, String password)  async{
    try {
      ...
      if(userCredential.user != null){
        ...
        signupEmail(userCredential.user.uid).then((resultCode){
          if(resultCode){
  ...
  Future signupEmail(String key) async{
    try{
