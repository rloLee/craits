...
class SimilarPharmacySelect extends StatelessWidget {
    ...
    return GestureDetector(
      ...
      child: DefaultTabController(
        ...
        child: Scaffold(
          ...
          body: TabBarView(
            children: <Widget>[
              AutoSelect(pharmacyName, pharmacyList, onApply),
              InputSelect(onApply),
            ],
          )
        )
...
class _AutoSelectState extends State<AutoSelect> {
  ...
  Widget build(BuildContext context) {
          ...
          Expanded(
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                Text('찾고계신 약국이 맞나요?', style: Theme.of(context).textTheme.headline1,),
                SizedBox(height: 5,),
                Text('${widget.hospitalName}과 비슷한 약국', style: Theme.of(context).textTheme.headline5, ),
                SizedBox(height: 20,),
                Expanded(
    ...
    return Container(
      padding: EdgeInsets.all(20),
      child: NoData('${widget.hospitalName}과 비슷한 약국을 찾지 못했습니다.'),
    );
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  if(bLoading)
                    ...
                    Expanded(
                      child:(pharmacyList != null && pharmacyList.info != null)?
                              ListView.builder(
                                itemCount: pharmacyList.info.list.length,
                                itemBuilder: (context, index){
                                  return ListTile(
                                      ...
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          child: Column(
                                            ...
                                            mainAxisAlignment: MainAxisAlignment.spaceAround,
                                              children: [
                                                Text('${pharmacyList.info.list[index].pharmacyNm}', style: TextStyle(color: (selectedIndex == index)
                                                    ? Theme.of(context).primaryColor 
                                                    : const Color(0xFF9F9F9F), 
                                                  fontWeight: FontWeight.w500),
                                                  maxLines: 1,
                                                ...
                                                Text('(${pharmacyList.info.list[index].addr})', 
                                                  style: TextStyle(
                                                    color: (selectedIndex == index)
                                                      ? Theme.of(context).primaryColor 
                                                      : const Color(0xFF9F9F9F), 
                                      ...
                                      onPressed: (){
                                        ...
                                        setState(() {
                                          ...
                                          hospital = JRecordInfoHospitalListUnit(
                                            id: pharmacyList.info.list[index].id, 
                                            name: pharmacyList.info.list[index].pharmacyNm, 
                                            addr: pharmacyList.info.list[index].addr, 
                                            tel: pharmacyList.info.list[index].telNo, 
                                            similar: '1');
                                        });
                                      }
                                    )
