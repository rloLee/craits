...
class PopupPark extends StatelessWidget {
          ...
          child: Column(
            ...
            children: [
              ...
              RichText(
                ...
                text: TextSpan(
                  children: <TextSpan>[
                    TextSpan(text: '이용하신 병원에',style: TextStyle(fontSize: 18.0, color: Color(0xFF262626), fontFamily: 'SpoqaHanSansNeo',), ),
                    TextSpan(text: '\n',style: TextStyle(fontSize: 18.0)),
                    TextSpan(text: '주차장',style: TextStyle(fontSize: 18.0, color: Theme.of(context).primaryColor, fontFamily: 'SpoqaHanSansNeo', fontWeight: FontWeight.w700), ),
                    TextSpan(text: '은 있나요?',style: TextStyle(fontSize: 18.0, color: Color(0xFF262626), fontFamily: 'SpoqaHanSansNeo',), ),
                  ])),
              SizedBox(height: 10,),
              Row(
                children: [
