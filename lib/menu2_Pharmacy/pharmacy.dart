...
import 'package:craits/menu2_Pharmacy/pharmacyMap.dart';
...
import 'pharmacyUnit.dart';
import 'pharmacyFilter.dart';
...
class _PharmacyState extends State<Pharmacy> {
  ...
  int cntFilter = 0; 
  // String sLocation = '';
  // double dCurLat = 37.563600; //현재위치
  // double dCurLong = 126.962370 ; //현재위치
        ...
        return SliverList(
          delegate: SliverChildBuilderDelegate((context, index){
            if(index == count)
              ...
              return PharmacyUnit(context, pharmacyList.info.list[index], dCurLat, dCurLong);
          },
            ...
            children: [
              Row(
                children: [
                  ...
                  Text('현재 위치 : ${sSearchLocation??sLocation}'),
                  IconButton(
                    onPressed: (){
                      setState(() {
              ...
              TextButton(
                onPressed: 
                (pharmacyList != null && pharmacyList.info.list.length > 0)
                ? () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => PharmacyMap(dCurLat: dCurLat, dCurLong: dCurLong,)));
                }
                : null,
              ...
              Expanded(
                ...
                child: MaterialButton(
                  ...
                  onPressed: () {
                    showDialog(
                      context: context,
                      builder: (context) => PharmacyFilterDialog(
