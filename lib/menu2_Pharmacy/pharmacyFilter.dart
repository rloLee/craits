...
class PharmacyFilterDialog extends StatefulWidget {
  List<JFilterListCategoryUnit> selectedList = [];
  Function(List<JFilterListCategoryUnit> selectedList) onApply;

  PharmacyFilterDialog({this.selectedList, this.onApply});

  @override
  _PharmacyFilterDialogState createState() => _PharmacyFilterDialogState();
}

class _PharmacyFilterDialogState extends State<PharmacyFilterDialog> {
